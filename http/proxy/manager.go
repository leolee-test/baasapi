...
var extensionPorts = map[baasapi.ExtensionID]string{
	baasapi.RegistryManagementExtension:  "7001",
	baasapi.OAuthAuthenticationExtension: "7002",
}
...
func (manager *Manager) createDockerProxy(endpointURL *url.URL, tlsConfig *baasapi.TLSConfiguration) (http.Handler, error) {
...
func (manager *Manager) createProxy(endpoint *baasapi.Endpoint) (http.Handler, error) {
	...
	case baasapi.AgentOnDockerEnvironment:
