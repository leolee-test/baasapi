...
func decorateContainerList(containerData []interface{}, resourceControls []baasapi.ResourceControl) ([]interface{}, error) {
...
func filterContainersWithBlackListedLabels(containerData []interface{}, labelBlackList []baasapi.Pair) ([]interface{}, error) {
	filteredContainerData := make([]interface{}, 0)
...
func containerHasBlackListedLabel(containerLabels map[string]interface{}, labelBlackList []baasapi.Pair) bool {
