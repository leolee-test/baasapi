...
func (handler *Handler) createComposeStackFromFileContent(w http.ResponseWriter, r *http.Request, endpoint *baasapi.Endpoint) *httperror.HandlerError {
	...
	stack := &baasapi.Stack{
		...
		Name:       payload.Name,
		Type:       baasapi.DockerComposeStack,
...
func (handler *Handler) createComposeStackFromGitRepository(w http.ResponseWriter, r *http.Request, endpoint *baasapi.Endpoint) *httperror.HandlerError {
...
func (handler *Handler) createComposeStackFromFileUpload(w http.ResponseWriter, r *http.Request, endpoint *baasapi.Endpoint) *httperror.HandlerError {
...
func (handler *Handler) createComposeDeployConfig(r *http.Request, stack *baasapi.Stack, endpoint *baasapi.Endpoint) (*composeStackDeploymentConfig, *httperror.HandlerError) {
