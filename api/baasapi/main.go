...
func initSnapshotter(clientFactory *docker.ClientFactory) baasapi.Snapshotter {
...
func loadSnapshotSystemSchedule(jobScheduler baasapi.JobScheduler, snapshotter baasapi.Snapshotter, scheduleService baasapi.ScheduleService, endpointService baasapi.EndpointService, settingsService baasapi.SettingsService) error {
...
func initStatus(endpointManagement, snapshot bool, flags *baasapi.CLIFlags) *baasapi.Status {
...
func initJobService(dockerClientFactory *docker.ClientFactory) baasapi.JobService {
