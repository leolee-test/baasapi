...
(async () => {
  ...
  try {
    await Promise.all([
      ...
      //console.log('ok logging into insurance organization clients!');
      shopClient.login(),
      //console.log('ok logging into shop organization clients!');
      repairShopClient.login(),
      //console.log('ok logging into repairshop organization clients!');
      policeClient.login()
      //console.log('ok logging into police organization clients!');
    ]);
  } catch (e) {
